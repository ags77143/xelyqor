    ...
    <aside className="w-60 flex-shrink-0 bg-white border-r border-cream-darker flex flex-col h-full">
      ...
      <div className="p-4">
        ...
        <button
          ...
          className={`flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm transition-colors mb-1 ${!selectedSubject ? "bg-amber-pale text-amber font-semibold" : "text-ink hover:bg-cream"}`}
        >
          <BookOpen size={14} />
          All Lectures
        </button>
        {subjects?.map((s) => (
          <button
            ...
            className={`flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm transition-colors mb-1 ${selectedSubject === s.id ? "bg-amber-pale text-amber font-semibold" : "text-ink hover:bg-cream"}`}
          >
      ...
      <div className="p-4 flex-1 overflow-y-auto">
        ...
        {recentLectures.map((l) => (
          <button
            ...
            className={`flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm transition-colors mb-1 text-left group ${selectedLectureId === l.id ? "bg-amber-pale text-amber font-semibold" : "text-ink hover:bg-cream"}`}
          >
      ...
      <div className="border-t border-cream-darker" />
      <div className="p-4">
        <a href="/settings" className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm text-ink hover:bg-cream transition-colors">
          <Settings size={14} />
          Settings
        </a>
